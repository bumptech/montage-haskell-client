...
module Network.Riak.MontageClient.Proto.MontageClient.MontageEnvelope (MontageEnvelope(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Network.Riak.MontageClient.Proto.MontageClient.MontageWireMessages as MontageClient (MontageWireMessages)
 
data MontageEnvelope = MontageEnvelope{mtype :: !MontageClient.MontageWireMessages, msg :: !P'.ByteString,
