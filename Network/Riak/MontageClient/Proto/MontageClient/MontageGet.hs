...
module Network.Riak.MontageClient.Proto.MontageClient.MontageGet (MontageGet(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Network.Riak.MontageClient.Proto.MontageClient.MontageSubrequestSpec as MontageClient (MontageSubrequestSpec)
 
data MontageGet = MontageGet{bucket :: !P'.ByteString, key :: !P'.ByteString,
                             sub :: !(P'.Maybe MontageClient.MontageSubrequestSpec)}
