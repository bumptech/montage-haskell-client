...
module Network.Riak.MontageClient.Proto.MontageClient.MontageGetMany (MontageGetMany(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Network.Riak.MontageClient.Proto.MontageClient.MontageGet as MontageClient (MontageGet)
 
data MontageGetMany = MontageGetMany{gets :: !(P'.Seq MontageClient.MontageGet)}
