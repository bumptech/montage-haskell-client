...
module Network.Riak.MontageClient.Proto.MontageClient.MontageWireMessages (MontageWireMessages(..)) where
import Prelude ((+), (/), (.))
...
data MontageWireMessages = MONTAGE_GET
                         ...
                         | MONTAGE_GET_MANY
                         | DEPRICATED_MONTAGE_SET_REFERENCE
                         | MONTAGE_PUT_MANY
...
toMaybe'Enum 9 = Prelude'.Just DEPRICATED_MONTAGE_SET_REFERENCE
...
instance Prelude'.Enum MontageWireMessages where
  ...
  fromEnum DEPRICATED_MONTAGE_SET_REFERENCE = 9
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error
        "hprotoc generated code: toEnum failure for type Network.Riak.MontageClient.Proto.MontageClient.MontageWireMessages")
      . toMaybe'Enum
  ...
  succ MONTAGE_GET_MANY = DEPRICATED_MONTAGE_SET_REFERENCE
  succ DEPRICATED_MONTAGE_SET_REFERENCE = MONTAGE_PUT_MANY
  ...
  succ _
   = Prelude'.error
      "hprotoc generated code: succ failure for type Network.Riak.MontageClient.Proto.MontageClient.MontageWireMessages"
  ...
  pred DEPRICATED_MONTAGE_SET_REFERENCE = MONTAGE_GET_MANY
  pred MONTAGE_PUT_MANY = DEPRICATED_MONTAGE_SET_REFERENCE
  ...
  pred _
   = Prelude'.error
      "hprotoc generated code: pred failure for type Network.Riak.MontageClient.Proto.MontageClient.MontageWireMessages"
...
instance P'.ReflectEnum MontageWireMessages where
  reflectEnum
   = [(1, "MONTAGE_GET", MONTAGE_GET), (2, "MONTAGE_GET_REFERENCE", MONTAGE_GET_REFERENCE),
      ...
      (9, "DEPRICATED_MONTAGE_SET_REFERENCE", DEPRICATED_MONTAGE_SET_REFERENCE), (10, "MONTAGE_PUT_MANY", MONTAGE_PUT_MANY),
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".MontageClient.MontageWireMessages") ["Network", "Riak", "MontageClient", "Proto"] ["MontageClient"]
        "MontageWireMessages")
      ["Network", "Riak", "MontageClient", "Proto", "MontageClient", "MontageWireMessages.hs"]
      [(1, "MONTAGE_GET"), (2, "MONTAGE_GET_REFERENCE"), (3, "MONTAGE_GET_RESPONSE"), (4, "MONTAGE_COMMAND"),
       ...
       (9, "DEPRICATED_MONTAGE_SET_REFERENCE"), (10, "MONTAGE_PUT_MANY"), (11, "MONTAGE_PUT_MANY_RESPONSE"), (12, "MONTAGE_ERROR"),
