...
module Network.Riak.MontageClient.Proto.MontageClient.MontageGetStatus (MontageGetStatus(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum MontageGetStatus where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error
        "hprotoc generated code: toEnum failure for type Network.Riak.MontageClient.Proto.MontageClient.MontageGetStatus")
      . toMaybe'Enum
  succ EXISTS = MISSING
  succ MISSING = ERROR
  succ _
   = Prelude'.error "hprotoc generated code: succ failure for type Network.Riak.MontageClient.Proto.MontageClient.MontageGetStatus"
  pred MISSING = EXISTS
  pred ERROR = MISSING
  pred _
   = Prelude'.error "hprotoc generated code: pred failure for type Network.Riak.MontageClient.Proto.MontageClient.MontageGetStatus"
...
instance P'.ReflectEnum MontageGetStatus where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".MontageClient.MontageGetStatus") ["Network", "Riak", "MontageClient", "Proto"] ["MontageClient"]
        "MontageGetStatus")
      ["Network", "Riak", "MontageClient", "Proto", "MontageClient", "MontageGetStatus.hs"]
